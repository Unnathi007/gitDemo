...
// var str="Javatpoint";  
//  console.log(str.charAt(str.length-1));  // last one
...
// var web="Learn JavaScript on Javatpoint";  
//  console.log(web.indexOf('a',3));  //after 3rd index 
...
// var web="Learn JavaScript on Javatpoint";  //after 7th index
//  console.log(web.indexOf("Java",7) + "<br>");  
  

   
// var web="Learn JavaScript on Javatpoint";  
//  console.log(web.indexOf("java") + "<br>");  //returns -1 if not present case-sensitive 
   


   
// var str="JavaScript is a scripting language. Scripting languages are often interpreted";  
//  console.log(str.search("scripting") + "<br>");  // 
