...
var web="Learn JavaScript on Javatpoint";  
console.log(web.indexOf('a',3));  // search 'a' from index number 3
   
var web="Learn JavaScript on Javatpoint";  
console.log(web.indexOf("Java"));  
   
var web="Learn JavaScript on Javatpoint";  
console.log(web.indexOf("Java",7));  //search 'Java' from index 7
...
var str="JavaScript is a scripting language. Scripting languages are often interpreted";  
console.log(str.search(/Scripting/i));  //i: ignoring case-sensitive
   
var str="JavaScript is a scripting language. Scripting languages are often interpreted";  
console.log(str.search(/Javatpoint/));  
   
var str="Javatpoint";  
console.log(str.match(/Java/g));  //g: global
